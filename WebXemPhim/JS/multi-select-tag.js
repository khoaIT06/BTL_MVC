function MultiSelectTag (el, customs = {shadow: false, rounded:true}) {
    ...
    // Gán hàm này để có thể sử dụng từ bên ngoài
    ...
    function init() {
        ...
        const modalAddContainerTag = document.querySelector('.js-modal-addMovie-container')
        modalAddContainerTag.addEventListener('click', (e) => {
            if(!customSelectContainer.contains(e.target)){
                drawer.classList.add('hidden')
            }
        });

        const modalChangeContainerTag = document.querySelector('.js-modal-changeMovie-container')
        modalChangeContainerTag.addEventListener('click', (e) => {
            if(!customSelectContainer.contains(e.target)){
                drawer.classList.add('hidden')
            }
        });
    ...
    function clearSelectedOptions() {
        ...
        while (inputContainer.firstChild && inputContainer.firstChild !== inputBody) {
...
const multiSelectCategory = new MultiSelectTag('movie-category-change', { placeholder: 'Chọn thể loại...' });
const multiSelectCategoryAdd = new MultiSelectTag('movie-category-add', { placeholder: 'Chọn thể loại...' });